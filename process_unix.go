...
// setShellCmdLine has nothing to do here: /bin/sh -c receives the line as its
// own argv element via execve, with no intermediate re-parsing step for Go's
// escaping to fight with, unlike cmd.exe on Windows.
